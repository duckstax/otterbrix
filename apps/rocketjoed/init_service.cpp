...
/// rewrite config
        ...
        //auto& ws = env.add_data_provider<rocketjoe::data_provider::ws::ws>(router->entry_point());
        init_http();
        auto& http = env.add_data_provider<rocketjoe::data_provider::http::http_server>(router->entry_point());
