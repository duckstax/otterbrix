...
protected:
    spaces(){
        ...
        manager_database = goblin_engineer::make_manager_service<services::storage::manager_database_t>(log, 1, 1000);
        database = goblin_engineer::make_manager_service<<services::storage::database_t>(manager_database, log, 1, 1000);
        collection = goblin_engineer::make_service<<services::storage::collection_t>(database, log);
    ...
    services::storage::manager_database_ptr manager_database;
