namespace Duckstax.EntityFramework.Otterbrix
{
    ...
    public class DocumentWrapper
    {
        ...
        public string ID()
        {
            IntPtr str_ptr = DocumentID(doc_ptr_);
        ...
        {
            return DocumentIsExistByKey(doc_ptr_, new StringPasser(ref key));
        }
        ...
        {
            return DocumentIsNullByKey(doc_ptr_, new StringPasser(ref key));
        }
        ...
        {
            return DocumentIsBoolByKey(doc_ptr_, new StringPasser(ref key));
        }
        ...
        {
            return DocumentIsUlongByKey(doc_ptr_, new StringPasser(ref key));
        }
        ...
        {
            return DocumentIsLongByKey(doc_ptr_, new StringPasser(ref key));
        }
        ...
        {
            return DocumentIsDoubleByKey(doc_ptr_, new StringPasser(ref key));
        }
        ...
        {
            return DocumentIsStringByKey(doc_ptr_, new StringPasser(ref key));
        }
        ...
        {
            return DocumentIsArrayByKey(doc_ptr_, new StringPasser(ref key));
        }
        ...
        {
            return DocumentIsDictByKey(doc_ptr_, new StringPasser(ref key));
        }
        ...
        {
            return DocumentGetBoolByKey(doc_ptr_, new StringPasser(ref key));
        }
        ...
        {
            return DocumentGetUlongByKey(doc_ptr_, new StringPasser(ref key));
        }
        ...
        {
            return DocumentGetLongByKey(doc_ptr_, new StringPasser(ref key));
        }
        ...
        {
            return DocumentGetDoubleByKey(doc_ptr_, new StringPasser(ref key));
        }
        ...
        {
            IntPtr str_ptr = DocumentGetStringByKey(doc_ptr_, new StringPasser(ref key));
            string result = Marshal.PtrToStringAnsi(str_ptr);
            Marshal.FreeHGlobal(str_ptr);
            return result;
        }
        ...
        {
            IntPtr str_ptr = DocumentGetStringByIndex(doc_ptr_, index);
            string result = Marshal.PtrToStringAnsi(str_ptr);
            Marshal.FreeHGlobal(str_ptr);
            return result;
        }
        ...
        {
            return new DocumentWrapper(DocumentGetArrayByKey(doc_ptr_, new StringPasser(ref key)));
        }
        ...
        {
            return new DocumentWrapper(DocumentGetDictByKey(doc_ptr_, new StringPasser(ref key)));
        }
