...
namespace duck_charmer {
    ...
    public:
        ...
        auto find(session_id_t &session, components::ql::aggregate_statement_ptr& condition) -> components::cursor::cursor_t*;
        auto find_one(session_id_t &session, components::ql::aggregate_statement_ptr& condition) -> result_find_one&;
        auto delete_one(session_id_t &session, components::ql::aggregate_statement_ptr& condition) -> result_delete&;
        auto delete_many(session_id_t &session, components::ql::aggregate_statement_ptr& condition) -> result_delete&;
        auto update_one(session_id_t &session, components::ql::aggregate_statement_ptr& condition, document_ptr update, bool upsert) -> result_update&;
        auto update_many(session_id_t &session, components::ql::aggregate_statement_ptr& condition, document_ptr update, bool upsert) -> result_update&;
