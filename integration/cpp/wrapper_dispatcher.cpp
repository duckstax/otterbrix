...
namespace duck_charmer {
    ...
    auto wrapper_dispatcher_t::find(session_id_t &session, const components::ql::find_statement_ptr &condition) -> components::cursor::cursor_t* {
    ...
    auto wrapper_dispatcher_t::find_one(components::session::session_id_t &session, const components::ql::find_statement_ptr &condition) -> result_find_one & {
    ...
    auto wrapper_dispatcher_t::delete_one(components::session::session_id_t &session, const components::ql::find_statement_ptr &condition) -> result_delete & {
    ...
    auto wrapper_dispatcher_t::delete_many(components::session::session_id_t &session, const components::ql::find_statement_ptr &condition) -> result_delete &{
    ...
    auto wrapper_dispatcher_t::update_one(components::session::session_id_t &session, const components::ql::find_statement_ptr &condition, document_ptr update, bool upsert) -> result_update & {
    ...
    auto wrapper_dispatcher_t::update_many(components::session::session_id_t &session, const components::ql::find_statement_ptr &condition, document_ptr update, bool upsert) -> result_update & {
