...
namespace otterbrix {
    ...
    base_otterbrix_t::base_otterbrix_t(const configuration::config& config)
        ...
        if (config.wal.on) {
            auto wal = actor_zeta::spawn_supervisor<services::wal::manager_wal_replicate_t>(resource,
                                                                                            scheduler_.get(),
                                                                                            config.wal,
                                                                                            log_);
            ...
            auto wal_empty =
                actor_zeta::spawn_supervisor<services::wal::manager_wal_replicate_empty_t>(resource,
                                                                                           scheduler_.get(),
                                                                                           log_);
        ...
        if (config.disk.on) {
            auto disk = actor_zeta::spawn_supervisor<services::disk::manager_disk_t>(resource,
                                                                                     scheduler_.get(),
                                                                                     config.disk,
                                                                                     log_);
