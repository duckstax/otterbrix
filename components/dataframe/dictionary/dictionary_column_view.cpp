...
namespace components::dataframe::dictionary {
    ...
    dictionary_column_view::dictionary_column_view(column_view const& dictionary_column)
        ...
        assertion_exception_msg(type().id() == type_id::dictionary32,"dictionary_column_view only supports DICTIONARY type");
    ...
    column::column_view dictionary_column_view::parent() const noexcept {
