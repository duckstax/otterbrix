...
namespace services::collection::operators::predicates {
    ...
    public:
        simple_predicate(std::function<bool(const components::document::document_ptr&,
                                            const components::document::document_ptr&,
                                            const components::logical_plan::storage_parameters*)> func);
        simple_predicate(std::vector<predicate_ptr>&& nested, components::expressions::compare_type nested_type);
