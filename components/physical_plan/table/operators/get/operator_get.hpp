...
namespace services::table::operators::get {
    ...
    public:
        components::types::logical_value_t value(const std::pmr::vector<components::types::logical_value_t>& row);
    ...
    private:
        virtual components::types::logical_value_t
        get_value_impl(const std::pmr::vector<components::types::logical_value_t>& row) = 0;
    };
