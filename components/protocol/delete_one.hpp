...
struct delete_one_t : statement_t {
...
namespace msgpack {
    MSGPACK_API_VERSION_NAMESPACE(MSGPACK_DEFAULT_API_NS) {
        namespace adaptor {
            ...
            template<>
            struct convert<delete_one_t> final {
                msgpack::object const &operator()(msgpack::object const &o, delete_one_t &v) const {
                    ...
                    v = delete_one_t(database, collection, condition);
                    return o;
                }
            };

            template<>
            struct pack<delete_one_t> final {
                template<typename Stream>
                packer<Stream>& operator()(msgpack::packer<Stream> &o, delete_one_t const &v) const {
                    o.pack_array(3);
                    o.pack(v.database_);
            ...
            template<>
            struct object_with_zone<delete_one_t> final {
                void operator()(msgpack::object::with_zone &o, delete_one_t const &v) const {
                    o.type = type::ARRAY;
                    o.via.array.size = 3;
