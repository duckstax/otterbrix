...
namespace msgpack {
    MSGPACK_API_VERSION_NAMESPACE(MSGPACK_DEFAULT_API_NS) {
        namespace adaptor {
            ...
            template<>
            struct convert<components::protocol::create_database_t> final {
                msgpack::object const& operator()(msgpack::object const& o, components::protocol::create_database_t& v) const {
            ...
            template<>
            struct pack<components::protocol::create_database_t> final {
                template<typename Stream>
                packer<Stream>& operator()(msgpack::packer<Stream>& o, components::protocol::create_database_t const& v) const {
                    o.pack_array(1);
                    o.pack(v.database_);
                    return o;
                }
            ...
            template<>
            struct object_with_zone<components::protocol::create_database_t> final {
                void operator()(msgpack::object::with_zone& o, components::protocol::create_database_t const& v) const {
                    o.type = type::ARRAY;
                    o.via.array.size = 1;
