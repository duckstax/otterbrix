	...
	if (*loc == YY_END_OF_BUFFER_CHAR)
	{
		ereport(ERROR,
				(errcode(ERRCODE_SYNTAX_ERROR),
				 ...
				 errmsg("%s at end of input"), // mdxn: originally  errmsg("%s at end of input", _(message)), gettext from c.h
				 lexer_errposition()));
	}
	else
	{
		ereport(ERROR,
				(errcode(ERRCODE_SYNTAX_ERROR),
				 ...
				 errmsg("%s at or near \"%s\"", loc),  // mdxn: originally  errmsg("%s at end of input", _(message)), gettext from c.h
				 lexer_errposition()));
	}
}
