...
TEST_CASE("sql_new::raw_parser_create") {
...
TEST_CASE("sql_new::raw_parser_select") {
...
TEST_CASE("sql_new::raw_parser_update") {
...
TEST_CASE("sql_new::raw_parser_insert") {
...
TEST_CASE("sql_new::raw_parser_drop") {
...
TEST_CASE("sql_new::raw_parser_index") {
