...
namespace components::cursor {
    ...
    public:
        ...
        data_cursor_t(std::vector<components::storage::document_view_t> data);
        std::size_t size() const;
    private:
        std::vector<storage::document_view_t> data_;
    };
    ...
    private:
        ...
        std::vector<components::storage::document_view_t>::const_iterator it;
        data_cursor_t* data_;
    };
