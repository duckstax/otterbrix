...
namespace components::ql {
    ...
    struct update_many_t final : ql_param_statement_t {
        explicit update_many_t(const database_name_t& database,
        ...
        explicit update_many_t(components::ql::aggregate_statement_raw_ptr condition,
                               const components::document::document_ptr& update,
                               bool upsert);
        explicit update_many_t(std::pmr::memory_resource* resource)
            : ql_param_statement_t(resource)
    ...
    inline update_many_t to_update_many(const msgpack::object& msg_object, std::pmr::memory_resource* resource) {
        ...
        return update_many_t(database, collection, condition, parameters, update, upsert);
    }
} // namespace components::ql
