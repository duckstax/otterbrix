...
namespace components::logical_plan {
    ...
    node_ptr make_node_drop_collection(std::pmr::memory_resource* resource,
                                       ql::drop_collection_t *ql) {
        auto node = new node_drop_collection_t{resource, {ql->database_, ql->collection_}};
        return node;
    }
