...
namespace document::impl {
    ...
    class array_t : public value_t {
        struct impl {
            ...
            explicit impl(const value_t*) noexcept;
    ...
    public:
        explicit array_iterator_t(const array_t* a) noexcept;
        ...
        const value_t* operator[](unsigned i) const noexcept PURE { return static_cast<const impl&>(*this)[i]; }
