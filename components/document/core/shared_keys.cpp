...
namespace document::impl {
    ...
    bool key_t::shared() const { return _string.empty(); }
    ...
    std::string_view key_t::as_string() const { return {_string.data(), _string.size()}; }
    ...
    bool shared_keys_t::_is_unknown_key(int key) const { return static_cast<unsigned>(key) >= _count; }
    ...
    bool shared_keys_t::refresh() { return false; }
