...
{
public:
    retained_t() noexcept                         : _ref(nullptr) {}
    retained_t(T *t) noexcept                     : _ref(retain(t)) {}

    retained_t(const retained_t &r) noexcept      : _ref(retain(r._ref)) {}
    retained_t(retained_t &&r) noexcept           : _ref(std::move(r).detach()) {}

    template <typename U>
    retained_t(const retained_t<U> &r) noexcept   : _ref(retain(r._ref)) {}

    template <typename U>
    retained_t(retained_t<U> &&r) noexcept        : _ref(std::move(r).detach()) {}
    ...
    retained_t& operator=(T *t) noexcept          { assign_ref(_ref, t); return *this; }

    retained_t& operator=(const retained_t &r) noexcept     { return *this = r._ref; }

    template <typename U>
    retained_t& operator=(const retained_t<U> &r) noexcept  { return *this = r._ref; }
...
private:
    template <class U> friend class retained_t;
    template <class U> friend class retained_const_t;
    template <class U> friend retained_t<U> adopt(U*) noexcept;

    retained_t(T *t, bool) noexcept                         : _ref(t) {}
...
public:
    retained_const_t() noexcept                               : _ref(nullptr) {}
    retained_const_t(const T *t) noexcept                     : _ref(retain(t)) {}
    retained_const_t(const retained_const_t &r) noexcept      : _ref(retain(r._ref)) {}
    retained_const_t(retained_const_t &&r) noexcept           : _ref(std::move(r).detach()) {}
    retained_const_t(const retained_t<T> &r) noexcept         : _ref(retain(r._ref)) {}
    retained_const_t(retained_t<T> &&r) noexcept              : _ref(std::move(r).detach()) {}
    ...
    retained_const_t& operator=(const retained_const_t &r) noexcept {
        return *this = r._ref;
    }
