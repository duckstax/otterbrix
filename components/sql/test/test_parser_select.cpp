...
TEST_CASE("parser::select_from_where") {
    ...
    TEST_SIMPLE_SELECT(
        R"_(select * from schema.table where number = 10 and name = 'doc 10' and "count" = 2;)_",
    ...
    TEST_SIMPLE_SELECT(
        R"_(select * from schema.table where number = 10 and name = 'doc 10' or "count" = 2;)_",
    ...
    TEST_SIMPLE_SELECT(
        R"_(select * from schema.table where not (number = 10) and not(name = 'doc 10' or "count" = 2);)_",
...
TEST_CASE("parser::select_without_from") {
    ...
    TEST_SELECT_WITHOUT_FROM(R"_(select 'title' as title;)_",
                             ...
                             vec({new_value(std::pmr::string("title"))}));

    TEST_SELECT_WITHOUT_FROM(R"_(select 10;)_", R"_($aggregate: {$group: {10: #0}})_", vec({new_value(10l)}));
    ...
    TEST_SELECT_WITHOUT_FROM(R"_(select 10, 'title';)_",
                             ...
                             vec({new_value(10l), new_value(std::pmr::string("title"))}));
}
