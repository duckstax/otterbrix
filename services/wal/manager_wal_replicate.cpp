...
namespace services::wal {
    ...
    manager_wal_replicate_t::manager_wal_replicate_t(actor_zeta::detail::pmr::memory_resource*mr,boost::filesystem::path path, log_t& log, size_t num_workers, size_t max_throughput)
