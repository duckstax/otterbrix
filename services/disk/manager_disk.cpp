...
namespace services::disk {
    ...
    auto agent_disk_t::read_databases(session_id_t& session) -> void {
        ...
        actor_zeta::send( current_message()->sender(), address(), route::read_databases_finish, session, result_read_databases(disk_.databases()));
    }
    ...
    auto agent_disk_t::read_collections(session_id_t& session, const database_name_t& database) -> void {
        ...
        actor_zeta::send( current_message()->sender(), address(), route::read_collections_finish, session, result_read_collections(disk_.collections(database)));
    }
    ...
    auto agent_disk_t::read_documents(session_id_t& session, const database_name_t& database, const collection_name_t& collection) -> void {
        ...
        actor_zeta::send( current_message()->sender(), address(), route::read_documents_finish, session, result_read_documents(std::move(documents)));
    }
