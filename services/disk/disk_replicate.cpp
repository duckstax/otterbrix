...
namespace services::disk {
    ...
    disk_manager_t::disk_manager_t(goblin_engineer::supervisor_t *manager, const std::string &file_name, log_t& log)
        : goblin_engineer::abstract_service(manager, "disk_manager")
        , log_(log.clone())
        , disk_(file_name) {
        add_handler(route::read_databases, &disk_manager_t::read_databases);
        add_handler(route::append_database, &disk_manager_t::append_database);
        add_handler(route::remove_database, &disk_manager_t::remove_database);
        add_handler(route::read_collections, &disk_manager_t::read_collections);
        add_handler(route::append_collection, &disk_manager_t::append_collection);
        add_handler(route::remove_collection, &disk_manager_t::remove_collection);
        add_handler(route::read_documents, &disk_manager_t::read_documents);
        add_handler(route::write_documents, &disk_manager_t::write_documents);
        add_handler(route::remove_documents, &disk_manager_t::remove_documents);
    }

    disk_manager_t::~disk_manager_t() {
    }

    auto disk_manager_t::read_databases(session_t& session) -> void {
    ...
    auto disk_manager_t::append_database(session_t& session, const database_name_t &database) -> void {
    ...
    auto disk_manager_t::remove_database(session_t& session, const database_name_t &database) -> void {
    ...
    auto disk_manager_t::read_collections(session_t& session, const database_name_t &database) -> void {
    ...
    auto disk_manager_t::append_collection(session_t& session, const database_name_t &database, const collection_name_t &collection) -> void {
    ...
    auto disk_manager_t::remove_collection(session_t& session, const database_name_t &database, const collection_name_t &collection) -> void {
    ...
    auto disk_manager_t::read_documents(session_t& session, const database_name_t &database, const collection_name_t &collection) -> void {
    ...
    auto disk_manager_t::write_documents(session_t& session, const database_name_t &database, const collection_name_t &collection, const std::vector<document_ptr> &documents) -> void {
    ...
    auto disk_manager_t::remove_documents(session_t& session, const database_name_t &database, const collection_name_t &collection, const std::vector<document_id_t> &documents) -> void {
