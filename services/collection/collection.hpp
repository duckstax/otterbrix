...
namespace services::collection {
    ...
    public:
        ...
        auto find(const session_id_t& session, const components::logical_plan::node_ptr& logic_plan, const components::ql::storage_parameters& parameters) -> void;
        auto find_one(const session_id_t& session, const components::logical_plan::node_ptr& logic_plan, const components::ql::storage_parameters& parameters) -> void;
        auto delete_one(const session_id_t& session, const components::logical_plan::node_ptr& logic_plan, const components::ql::storage_parameters& parameters) -> void;
        auto delete_many(const session_id_t& session, const components::logical_plan::node_ptr& logic_plan, const components::ql::storage_parameters& parameters) -> void;
        auto update_one(const session_id_t& session, const components::logical_plan::node_ptr& logic_plan, const components::ql::storage_parameters& parameters, const document_ptr& update, bool upsert) -> void;
        auto update_many(const session_id_t& session, const components::logical_plan::node_ptr& logic_plan, const components::ql::storage_parameters& parameters, const document_ptr& update, bool upsert) -> void;
    ...
    private:
        ...
        bool drop_();
        void delete_(planner::transaction_context_t* transaction_context, const session_id_t& session, const components::logical_plan::node_ptr& logic_plan, const components::ql::storage_parameters& parameters, const operators::predicates::limit_t &limit);
        void update_(planner::transaction_context_t* transaction_context, const session_id_t& session, const components::logical_plan::node_ptr& logic_plan, const components::ql::storage_parameters& parameters, const document_ptr& update, bool upsert, const operators::predicates::limit_t &limit);
