...
template <> struct nearest_field_type_impl<char> { using Type = std::conditional_t<std::is_signed_v<char>, std::int64_t, std::uint64_t>; };
template <> struct nearest_field_type_impl<signed char> { using Type = std::int64_t; };
template <> struct nearest_field_type_impl<unsigned char> { using Type = std::uint64_t; };

template <> struct nearest_field_type_impl<std::uint16_t> { using Type = std::uint64_t; };
template <> struct nearest_field_type_impl<std::uint32_t> { using Type = std::uint64_t; };


template <> struct nearest_field_type_impl<std::int16_t> { using Type = std::int32_t; };
template <> struct nearest_field_type_impl<std::int32_t> { using Type = std::int64_t; };

/// long and long long are always different types that may behave identically or not.
/// This is different on Linux and Mac.
template <> struct nearest_field_type_impl<long> { using Type = std::int64_t; }; /// NOLINT
template <> struct nearest_field_type_impl<long long> { using Type = std::int64_t; }; /// NOLINT
template <> struct nearest_field_type_impl<unsigned long> { using Type = std::uint64_t; }; /// NOLINT
template <> struct nearest_field_type_impl<unsigned long long> { using Type = std::uint64_t; }; /// NOLINT
/*
 ...
 */
template <> struct nearest_field_type_impl<float> { using Type = float; };
template <> struct nearest_field_type_impl<double> { using Type = double; };
template <> struct nearest_field_type_impl<const char *> { using Type = std::string; };
template <> struct nearest_field_type_impl<std::string_view> { using Type = std::string; };
template <> struct nearest_field_type_impl<std::string> { using Type = std::string; };
template <> struct nearest_field_type_impl<field_array_t> { using Type = field_array_t; };
template <> struct nearest_field_type_impl<field_tuple_t> { using Type = field_tuple_t; };
template <> struct nearest_field_type_impl<field_map_t> { using Type = field_map_t; };
template <> struct nearest_field_type_impl<field_object_t> { using Type = field_object_t; };
template <> struct nearest_field_type_impl<bool> { using Type = std::uint64_t; };
///template <> struct nearest_field_type_impl<Null> { using Type = Null; };

template <> struct nearest_field_type_impl<AggregateFunctionStateData> { using Type = AggregateFunctionStateData; };
