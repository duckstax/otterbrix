...
namespace rocketjoe { namespace http {
        ...
        constexpr const char *dispatcher = "dispatcher";
            ...
            public:
                ...
                impl(goblin_engineer::dynamic_config& configuration,actor_zeta::actor::actor_address address,actor_zeta::actor::actor_address http_address):
                ...
                void do_accept() {
                    ...
                    session_ = std::make_unique<http_session>(acceptor_->get_io_context(),id_,*this);
                ...
                auto operator()(request_type && req,std::size_t session_id) const -> void  {
                    ...
                    http_query_context  context(std::move(req),session_id,http_address_);
